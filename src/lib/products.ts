...
export const products: Product[] = [
  ...
  { id: "loft-1000", name: "Compact Loft Unit", capacity: "1,000 L", category: "Domestic", image: loft, price: "KSh 9,800", description: "Slim rectangular profile fits standard ceiling cavities and tight spaces." },
  
  // DOMESTIC & CHEMICAL - 1500-2000L
  { id: "chem-1500", name: "Chemical Storage 1500", capacity: "1,500 L", category: "Chemical", image: chemical, price: "KSh 19,500", description: "Chemical-resistant polyethylene formulation for fertilizers and agrochemicals." },
  ...
  // AGRICULTURAL & INDUSTRIAL - 2500-3000L
  { id: "h-2500", name: "Horizontal Transport 2500L", capacity: "2,500 L", category: "Agricultural", image: horizontal, price: "KSh 22,000", description: "Designed for transport on pickups and tractors—includes steel base frame." },
  ...
  // SANITATION & INDUSTRIAL - 3500-4000L
  { id: "septic-3500", name: "Underground Septic", capacity: "3,500 L", category: "Sanitation", image: septic, price: "KSh 38,000", description: "Reinforced ribbed shell handles soil pressure for long-lasting underground installation." },
  ...
  { id: "septic-5000", name: "Horizontal Septic Tank", capacity: "5,000 L", category: "Sanitation", image: septic, price: "KSh 58,000", description: "Heavy-duty ribbed horizontal septic tank for underground use." },
  ...
  { id: "cone-2000", name: "Cone Bottom Processor", capacity: "2,000 L", category: "Industrial", image: cone, price: "KSh 28,500", description: "Drainage-friendly cone bottom with steel support frame." },
  ...
  { id: "t-16000", name: "16,000L Water Tank", capacity: "16,000 L", category: "Industrial", image: vertical, price: "KSh 67,500", description: "Large capacity tank for industrial and large-scale applications." },
  { id: "t-20000", name: "20,000L Water Tank", capacity: "20,000 L", category: "Industrial", image: vertical, price: "KSh 98,500", description: "Large capacity tank for industrial and large-scale applications." },
  { id: "t-24000", name: "24,000L Water Tank", capacity: "24,000 L", category: "Industrial", image: vertical, price: "KSh 135,000", description: "Large capacity tank for industrial and large-scale applications." },
];
