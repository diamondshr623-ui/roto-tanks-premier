...
export const products: Product[] = [
  ...
  { id: "chem-1500", name: "Chemical Storage 1500", capacity: "1,500 L", category: "Chemical", image: chemical, price: "KSh 19,500", description: "Chemical-resistant polyethylene formulation for fertilizers and detergents." },
  ...
  { id: "h-2500", name: "Horizontal Transport 2500L", capacity: "2,500 L", category: "Agricultural", image: horizontal, price: "KSh 22,000", description: "Designed for transport on pickups and trailers with balanced weight distribution." },
  ...
  { id: "septic-3500", name: "Underground Septic", capacity: "3,500 L", category: "Sanitation", image: septic, price: "KSh 38,000", description: "Reinforced ribbed shell handles soil pressure for secure underground installation." },
  ...
  { id: "septic-5000", name: "Horizontal Septic Tank", capacity: "5,000 L", category: "Sanitation", image: septic, price: "KSh 58,000", description: "Heavy-duty ribbed horizontal septic tank for underground and above-ground use." },
